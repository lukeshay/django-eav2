...
"""
Abstract base models for EAV system.

These abstract models allow users to extend the EAV models with custom fields
by inheriting from these classes and setting the appropriate swappable model settings.
"""
...
from eav.logic.managers import AttributeManager, EnumGroupManager, EnumValueManager, ValueManager
...
class AbstractAttribute(models.Model):
    """
    Abstract base model for Attribute.
    ...
    enum_group: ForeignKey[Optional[Any]] = ForeignKey(
        "eav.EnumGroup",
    ...
    def validate_value(self, value):
        ...
        """
        from eav.conf import get_enum_value_model
...
class AbstractValue(models.Model):
    ...
    # Direct foreign keys
    attribute: ForeignKey[Any] = ForeignKey(
        "eav.Attribute",
        db_index=True,
        on_delete=models.PROTECT,
        verbose_name=_("Attribute"),
    ...
    value_enum: ForeignKey[Optional[Any]] = ForeignKey(
        "eav.EnumValue",
        blank=True,
        null=True,
        on_delete=models.PROTECT,
...
class AbstractEnumGroup(models.Model):
    """
    Abstract base model for EnumGroup.
    ...
    *EnumGroup* objects have two fields - a *name* ``CharField`` and *values*,
    ...
    values: ManyToManyField[Any, Any] = ManyToManyField(
        "eav.EnumValue",
...
class AbstractEnumValue(models.Model):
    """
    Abstract base model for EnumValue.
